...
import DefaultTab from '@src/widgets/default-friends-tab/ui/tab-default'
import { type FriendTabs } from '@src/shared/lib/types/other'
import FriendsTabButtons from '@src/widgets/filter-friends-tabs/ui/friends-tab-buttons'
