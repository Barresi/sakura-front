import LoginPage from '@src/pages/page-login/login'
import RegistrationPage from '@src/pages/page-registration/registration'
import { type FC, useEffect } from 'react'
import { Route, Routes } from 'react-router-dom'
import ProtectedRouteElement from './protected-route-element/protected-route-element'
import MainPage from '@src/pages/page-main/main'
import NotFoundPage from '@src/pages/page-not-found/not-found-page'
import FriendsPage from '@src/pages/page-friends/ui/friends-page/friends-page'
...
import MessengerPage from '@src/pages/page-messenger/messenger'
